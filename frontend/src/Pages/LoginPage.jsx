...
import { handleLoginWithGithub } from "../utils/handleLoginWithGithub";
        ...
        <div className='p-6 space-y-4 md:space-y-6 sm:p-8'>
          ...
          <button
            ...
            className='text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 
              ...
              font-medium rounded-lg flex gap-2 p-2 items-center w-full text-center justify-center hover:bg-slate-700'
